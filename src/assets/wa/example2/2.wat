(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18148))
 (memory $0 1)
 (data (i32.const 1036) ",")
 ...
 (data (i32.const 1548) ",")
 (data (i32.const 1560) "\01\00\00\00\18\00\00\00~\00l\00i\00b\00/\00m\00a\00t\00h\00.\00t\00s")
 (data (i32.const 1596) "<")
 ...
 (data (i32.const 1728) "\04\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1756) "\01\t\00\00\02")
 ...
 (export "randomizeArray" (func $export:assembly/index/randomizeArray))
 (export "sumArray" (func $export:assembly/index/sumArray))
 ...
 (func $export:assembly/index/randomizeArray (param $0 i32)
  (local $1 i64)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
 ...
 (func $export:assembly/index/sumArray (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
